...
$(document).ready(function() {
  ...
  stockagepositionsplayer1[0]={};stockagepositionsplayer1[1]={};stockagepositionsplayer1[2]={};stockagepositionsplayer1[3]={};stockagepositionsplayer1[4]={};
  stockagepositionsplayer1[0].nombateau = "porteavions";stockagepositionsplayer1[1].nombateau = "croiseur";stockagepositionsplayer1[2].nombateau = "contretorpilleur";stockagepositionsplayer1[3].nombateau = "sousmarin";stockagepositionsplayer1[4].nombateau = "torpilleur";
  for(g=0;g<5;g++) {
	  stockagepositionsplayer1[g].numero = [];
    stockagepositionsplayer1[g].lettre = [];
    /*stockagepositionsplayer1[g].vertical_lettre_ref = "";
    stockagepositionsplayer1[g].horizontal_numero_ref = "";
    stockagepositionsplayer1[g].typeplacement = "vertical";*/
  }
        		    ...
        		    if(statut=="ok") {
        				...
        				switch(bateauchoisi) {
        				  ...
        				  for(i=numero;i<parseInt(numero+taillebateau);i++) {
        					...
        					stockagepositionsplayer1[numerobateau].numero[tabnumber] = i;
        					tabnumber++;
                  }
                  stockagepositionsplayer1[numerobateau].lettre = lettre;
                  stockagepositionsplayer1[numerobateau].typeplacement = "vertical";
          ...
          //CLICK HORIZONTAL
            ...
            if(statutbateau=="paschoisi") {
              ...
              if(statut="ok") {
                ...
                stockagepositionsplayer1[numerobateau].typeplacement = "horizontal";
                stockagepositionsplayer1[numerobateau].horizontal_numero_ref = numero;
                var tabnumber = 0;
                for(i=numerolettre;i<parseInt(numerolettre+taillebateau);i++) {
                  $(String("#case_"+ordrelettres[i]+"_"+numero)).css("background-color",couleurchoisie).attr("class","casenormal_choisie");
      					  stockagepositionsplayer1[numerobateau].lettre[tabnumber] = ordrelettres[i];
      					  tabnumber++;
                }
                localStorage.setItem(bateauchoisi,"dejachoisi");
                checkPlacement();
...
function checkPlacement() {
      ...
      if((etat_choix_porteavions=="dejachoisi")&&(etat_choix_croiseur=="dejachoisi")&&(etat_choix_contretorpilleur=="dejachoisi")&&(etat_choix_sousmarin=="dejachoisi")&&(etat_choix_torpilleur=="dejachoisi")) {
        localStorage.setItem("stockagepositionsplayer1",JSON.stringify(stockagepositionsplayer1));

        $("<input>").attr({
          type:"button",
          value:"Configurer le joueur 2",
          id:"skip_choixbateau"
        }).appendTo("#box").on("click",() => {
          document.location.href = "formulaireplayer2.html";
        });
      }
}
